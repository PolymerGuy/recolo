...
slopes_from_matlab = loadmat("/home/sindreno/Downloads/Rene/slopes_1_0_set1_full2.mat")
slopes_y = slopes_from_matlab["slope_x"]
slopes_x = slopes_from_matlab["slope_y"]

disp_fields = -recon.slope_integration.disp_from_slopes(slopes_x, slopes_y, pixel_size, zero_at="bottom corners", extrapolate_edge=False, filter_sigma=10, downsample=5)
pixel_size = 3.0 / 1000.
...
fields = recon.kinematic_fields_from_experiments(disp_fields, pixel_size, sampling_rate, filter_time_sigma=0,
