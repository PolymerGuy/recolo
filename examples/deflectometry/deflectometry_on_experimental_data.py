...
path_to_example_imgs = os.path.join(recon.__path__[0], "tests/ExampleGridImages")
img_paths = recon.list_files_in_folder(path_to_example_imgs, file_type=".tif", abs_path=True)

# Grid image description
grid_pitch = 5  # pixels
mirror_grid_distance = 1.37  # m

slope_x, slope_y = recon.deflectomerty.slopes_from_images(path_to_example_imgs, grid_pitch, mirror_grid_distance)
